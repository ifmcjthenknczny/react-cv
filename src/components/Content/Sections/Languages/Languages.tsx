...
const Languages = () => <Block heading="Languages" content={<LanguagesContent languages={languages} />} />
...
const LanguageItem = ({ level, name, description }: Language) => {
    ...
    return <div className={styles.languageItem}>
        <div className={styles.imageWrapper} style={{ height: size, width: size }}>
            <img className={styles.level} src={flags[name]} alt='' /></div>
